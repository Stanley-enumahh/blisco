import AboutImage from "../assets/freshbread2.jpg";
  ...
  return (
    <div className="w-full flex relative justify-center h-fit md:h-[550px] pt-[60px] bg-[#fbf9ff] ">
      <div className="md:w-[85%] w-[90%] h-[80%] flex flex-col md:flex-row justify-between items-center">
        <div className="h-full w-full md:w-[45%]">
          <div className="flex flex-col gap-7">
            <div className="flex flex-col md:flex-row gap-2 items-center ">
              <h1 className="font-bold text-xl md:text-2xl flex flex-col gap-2 text-nowrap">
        ...
        <div className="bg-primary-color opacity-80 z-10 shadow-md md:rounded-br-3xl w-[50%] md:w-[20%] h-[20%] md:h-[50%] absolute bottom-0 md:bottom-[50px] right-0 md:right-[50px]"></div>
